...
const propiedades_alquiler = [
  {
    ...
    ubicacion: "123 Main Street, Downtown, CA 12345",
    habitaciones: 2,
    costo: 1500,
    smoke: false,
    pets: true,
...
const propiedades_venta = [
  ...
  },
  {
    ...
    descripcion:
      "Este penthouse de lujo ofrece una terraza con vistas panorámicas",
    ubicacion: "456 Panorama Drive, City Center, CA 12345",
    habitaciones: 3,
    costo: 3500,
    smoke: true,
    pets: true,
...
// funcion para mostrar propiedades en la página
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="${propiedad.pets ? "text-success" : "text-danger"}">
                  <i class="fa-solid fa-${propiedad.pets ? "paw" : "ban"}"></i> ${propiedad.pets ? "Mascotas permitidas" : "No se permiten mascotas"}
                </p>
              </div>
            </div>
          </div>`;
